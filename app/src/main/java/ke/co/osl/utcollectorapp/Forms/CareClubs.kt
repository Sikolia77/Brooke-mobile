...
class CareClubs: AppCompatActivity() {
    ...
    private fun searchCareclubs(d: Dialog) {
        ...
        submit.setOnClickListener {
            ...
            val apiInterface = ApiInterface.create().searchCareclubs(searchId.text.toString())

            apiInterface.enqueue( object : Callback<List<CareclubGetBody>> {
                override fun onResponse(call: Call<List<CareclubGetBody>>, response: Response<List<CareclubGetBody>>?) {
                    progress.visibility = View.GONE
                ...
                override fun onFailure(call: Call<List<CareclubGetBody>>, t: Throwable) {
                    progress.visibility = View.GONE
    ...
    private fun postFormDetails(){
        ...
        val clublevel = findViewById<EditText>(R.id.clublevel)
    ...
    private fun prefillForms (body: CareclubGetBody) {
        val next = findViewById<Button>(R.id.next)
        val error = findViewById<TextView>(R.id.error)
        val progress = findViewById<ProgressBar>(R.id.progress)
        val name = findViewById<EditText>(R.id.name)
        ...
        next.setOnClickListener {
            ...
            val careclubsBody = CareclubGetBody(
                id,
                objectid,
                name.text.toString(),
                contact.text.toString(),
