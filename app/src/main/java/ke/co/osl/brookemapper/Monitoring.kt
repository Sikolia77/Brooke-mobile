...
import ke.co.osl.brookemapper.Adapter.MonitoringAdapter
import ke.co.osl.brookemapper.Adapter.RecylerAdapter
import ke.co.osl.brookemapper.api.ApiInterface
import ke.co.osl.brookemapper.models.ChangePasswordBody
...
//        paramList.add(Params(R.drawable.customermeters, "Point Project"))
    ...
    private fun userRenewPassword(resetPasswordDialog: Dialog) {
        ...
        changePassword.setOnClickListener {
            ...
            apiInterface.enqueue(object : Callback<ke.co.osl.brookemapper.models.Message> {
                override fun onResponse(
                    call: Call<ke.co.osl.brookemapper.models.Message>?,
                    response: Response<ke.co.osl.brookemapper.models.Message>?
                ) {
                    //Print Response
