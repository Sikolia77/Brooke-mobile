...
class Agrovets: AppCompatActivity() {
    ...
    private fun searchAgrovets(d: Dialog) {
        ...
        submit.setOnClickListener {
            ...
            val apiInterface = ApiInterface.create().searchAgrovets(searchId.text.toString())

            apiInterface.enqueue( object : Callback<List<AgrovetGetBody>> {
                override fun onResponse(call: Call<List<AgrovetGetBody>>, response: Response<List<AgrovetGetBody>>?) {
                    progress.visibility = View.GONE
                ...
                override fun onFailure(call: Call<List<AgrovetGetBody>>, t: Throwable) {
                    progress.visibility = View.GONE
    ...
    private fun postFormDetails(){
        ...
        next.setOnClickListener {
            ...
            System.out.println("THE AGROVET BODY IS $agrovetBody")

            val apiInterface = ApiInterface.create().postAgrovet(agrovetBody)
            ...
            apiInterface.enqueue( object : Callback<Message> {
                override fun onResponse(call: Call<Message>?, response: Response<Message>?) {
                    ...
                    if(response?.body()?.success !== null){
                        ...
                        val intent = Intent(this@Agrovets, Home::class.java)
    ...
    private fun prefillForms (body: AgrovetGetBody) {
        val next = findViewById<Button>(R.id.next)
        val error = findViewById<TextView>(R.id.error)
        val progress = findViewById<ProgressBar>(R.id.progress)
        val name = findViewById<EditText>(R.id.name)
        ...
        next.setOnClickListener {
            ...
            val agrovetBody = AgrovetGetBody(
                id,
                objectid,
                name.text.toString(),
                county.selectedItem.toString(),
            ...
            System.out.println("Agrovets is " + agrovetBody)

            val apiInterface = ApiInterface.create().putAgrovet(body.ID,agrovetBody)
            apiInterface.enqueue( object : Callback<Message> {
                override fun onResponse(call: Call<Message>?, response: Response<Message>?) {
                    ...
                    if(response?.body()?.success !== null){
                        ...
                        val countdonwtimer = object: CountDownTimer(3000,1){
                            ...
                            override fun onFinish() {
                                progress.visibility = View.GONE
                                startActivity(Intent(this@Agrovets, Home::class.java))
                                finish()
                            }
                        }
