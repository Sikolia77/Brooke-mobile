package ke.co.osl.brookemapper.Forms
...
import ke.co.osl.brookemapper.*
import ke.co.osl.brookemapper.api.ApiInterface
import ke.co.osl.brookemapper.models.*
...
class Schools: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.schools_form)
    ...
    private fun searchSchools(d: Dialog) {
        ...
        submit.setOnClickListener {
            ...
            val apiInterface = ApiInterface.create().searchSchools(searchId.text.toString())

            apiInterface.enqueue( object : Callback<List<SchoolsGetBody>> {
                override fun onResponse(call: Call<List<SchoolsGetBody>>, response: Response<List<SchoolsGetBody>>?) {
                    progress.visibility = View.GONE
                ...
                override fun onFailure(call: Call<List<SchoolsGetBody>>, t: Throwable) {
                    progress.visibility = View.GONE
    ...
    private fun postFormDetails(){
        ...
        val clubactivities = findViewById<EditText>(R.id.clubactivities)
        ...
        next.setOnClickListener {
            ...
            if (TextUtils.isEmpty(name.text.toString())) {
                error.text = "School Name cannot be empty!"
                return@setOnClickListener
            }

            progress.visibility = View.VISIBLE
            val schoolsBody = SchoolsBody(
                name.text.toString(),
                ...
                ward.text.toString(),
                studentsno.text.toString(),
                clubactivities.text.toString(),
                user.text.toString()
            )



            val apiInterface = ApiInterface.create().postSchools(schoolsBody)
            ...
            apiInterface.enqueue( object : Callback<Message> {
                override fun onResponse(call: Call<Message>?, response: Response<Message>?) {
                    ...
                    if(response?.body()?.success !== null){
                        ...
                        val intent = Intent(this@Schools, Home::class.java)
    ...
    private fun prefillForms (body: SchoolsGetBody) {
        val next = findViewById<Button>(R.id.next)
        val error = findViewById<TextView>(R.id.error)
        val progress = findViewById<ProgressBar>(R.id.progress)
        val name = findViewById<EditText>(R.id.name)
        ...
        studentsno.setText(body.StudentsNo)
        clubactivities.setText(body.ClubActivities)
        ...
        next.setOnClickListener {
            ...
            val schoolsBody = SchoolsGetBody(
                id,
                objectid,
                name.text.toString(),
                contact.text.toString(),
            ...
            val apiInterface = ApiInterface.create().putSchools(body.ID,schoolsBody)
            apiInterface.enqueue( object : Callback<Message> {
                override fun onResponse(call: Call<Message>?, response: Response<Message>?) {
                    ...
                    if(response?.body()?.success !== null){
                        ...
                        val countdonwtimer = object: CountDownTimer(3000,1){
                            ...
                            override fun onFinish() {
                                progress.visibility = View.GONE
                                startActivity(Intent(this@Schools, Home::class.java))
                                finish()
                            }
                        }
